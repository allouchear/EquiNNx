...
def getData(mols):
	...
	if len(energy)>=1:
		...
		#meane=np.mean(data['energy'])
		#data['energy'] = data['energy']-meane
	else:
		data['energy'] = None
...
print("Building mols....", flush=True)
