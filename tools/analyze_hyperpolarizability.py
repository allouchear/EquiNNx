...
if len(sys.argv)<2:
        print("Usage :")
        print("      give the name of npz file , idx alpha (xxx, xxy, xyy,...) and the prefix name of the output file")
        print("      Example ", sys.argv[0], " train_dir/metrics/best_valid_valid_set.npz ", " xxx ", " beta ")
        exit(1)
...
predict=values['hyperpolarizability_predict'][:,i,j,k].reshape(-1)
target=values['hyperpolarizability_target'][:,i,j,k].reshape(-1)
